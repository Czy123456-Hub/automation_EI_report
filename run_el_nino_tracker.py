    ...
    return [
        {
            ...
            "date_label": "数据时间",
            "note": "",
            "explanation": "反映赤道中东太平洋 Niño 3.4 区域的一周平均海表温度距平，主要用于观察厄尔尼诺/拉尼娜状态的短期变化和转折信号。-0.5°C 到 +0.5°C 为中性；+0.5°C 到 +0.9°C 表示弱厄尔尼诺倾向；+1.0°C 到 +1.4°C 表示中等厄尔尼诺倾向；+1.5°C 到 +1.9°C 表示强厄尔尼诺倾向；+2.0°C 以上表示非常强厄尔尼诺倾向。-0.5°C 到 -0.9°C 表示弱拉尼娜倾向；-1.0°C 到 -1.4°C 表示中等拉尼娜倾向；-1.5°C 到 -1.9°C 表示强拉尼娜倾向；低于 -2.0°C 表示非常强拉尼娜倾向。",
        },
        {
            "title": "SOI 30天",
            ...
            "date_label": "数据时间",
            "note": "",
            "explanation": "反映 Tahiti 与 Darwin 两地海平面气压差的标准化异常，主要用于判断大气端是否和海温变化状态一致。-0.5 到 +0.5 为中性；-0.5 到 -1.0 表示偏厄尔尼诺型大气响应；低于 -1.0 表示明显厄尔尼诺型大气响应；低于 -1.5 表示较强厄尔尼诺型大气响应。+0.5 到 +1.0 表示偏拉尼娜型大气响应；高于 +1.0 表示明显拉尼娜型大气响应；高于 +1.5 表示较强拉尼娜型大气响应。",
        },
        {
            ...
            "date_label": "数据时间",
            "note": "区域：160E-80W",
            "explanation": "反映赤道太平洋上层 300 米海洋平均温度相对常年的偏离程度，主要用于判断赤道太平洋海表偏暖或偏冷背后是否有海洋内部热量支撑。-0.5°C 到 +0.5°C 为中性；+0.5°C 到 +1.0°C 表示暖水储备偏多，后续 Niño 3.4 海温偏暖可能维持；+1.0°C 到 +2.0°C 表示暖水储备明显偏多，后续厄尔尼诺倾向可能增强；高于 +2.0°C 表示暖水储备很强，后续厄尔尼诺发展或维持的概率较高。-0.5°C 到 -1.0°C 表示冷水储备偏多，后续 Niño 3.4 海温可能转弱或偏冷；-1.0°C 到 -2.0°C 表示冷水储备明显偏多，后续拉尼娜倾向可能增强；低于 -2.0°C 表示冷水储备很强，后续拉尼娜发展或维持的概率较高。",
        },
        {
            "title": "Niño 3.4 月度",
            ...
            "date_label": "数据月份",
            "note": "",
            "explanation": "反映赤道中东太平洋 Niño 3.4 区域的月平均海表温度距平，主要用于判断厄尔尼诺/拉尼娜状态的月度背景强弱。-0.5°C 到 +0.5°C 为中性；+0.5°C 到 +0.9°C 表示弱厄尔尼诺倾向；+1.0°C 到 +1.4°C 表示中等厄尔尼诺倾向；+1.5°C 到 +1.9°C 表示强厄尔尼诺倾向；+2.0°C 以上表示非常强厄尔尼诺倾向。-0.5°C 到 -0.9°C 表示弱拉尼娜倾向；-1.0°C 到 -1.4°C 表示中等拉尼娜倾向；-1.5°C 到 -1.9°C 表示强拉尼娜倾向；低于 -2.0°C 表示非常强拉尼娜倾向。",
        },
        {
            "title": "赤道 SOI",
            ...
            "date_label": "数据月份",
            "note": "",
            "explanation": "反映赤道太平洋附近海平面气压差的标准化异常，主要用于判断赤道太平洋的大气环流是否和海温变化状态一致。-0.5 到 +0.5 为中性；-0.5 到 -1.0 表示偏厄尔尼诺型赤道大气响应；低于 -1.0 表示明显厄尔尼诺型赤道大气响应；低于 -1.5 表示较强厄尔尼诺型赤道大气响应。+0.5 到 +1.0 表示偏拉尼娜型赤道大气响应；高于 +1.0 表示明显拉尼娜型赤道大气响应；高于 +1.5 表示较强拉尼娜型赤道大气响应。",
        },
        {
            "title": "IOD",
            ...
            "date_label": "数据时间",
            "note": "",
            "explanation": "反映热带印度洋西部和东部海温距平的差值，主要用于判断印度洋海温分布是否异常。-0.4°C 到 +0.4°C 为中性；+0.4°C 到 +0.8°C 表示正 IOD 倾向；高于 +0.8°C 表示较强正 IOD。-0.4°C 到 -0.8°C 表示负 IOD 倾向；低于 -0.8°C 表示较强负 IOD。正 IOD 通常可能支持印度季风降雨，负 IOD 则可能削弱印度季风水汽条件。",
        },
    ]
